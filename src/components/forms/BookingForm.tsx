...
export function BookingForm({ service }: BookingFormProps) {
  ...
  // Render State 1: Submission Success & Stripe checkout Gateway
  if (isSuccess) {
    return (
  ...
  // Render State 2: Standard Booking Form Page
  return (
    <div className="flex-grow bg-background py-12 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl flex flex-col gap-6">
        ...
        <Card className="border-foreground/10 bg-primary/5 rounded-none p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="sm:text-right flex flex-col justify-center animate-in fade-in duration-300">
