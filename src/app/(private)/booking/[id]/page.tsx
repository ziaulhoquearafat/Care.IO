...
export default function BookingPage({ params }: PageProps) {
  ...
  // 2. Cascading Dropdown Memoized Calculations
  // Region Selection
  ...
  // City Selection (Filtered by district)
  ...
  // Render State 3: Submission Success State
  if (isSuccess) {
    return (
  ...
  return (
    <div className="flex-grow bg-background py-12 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl flex flex-col gap-6">
        ...
        {/* 1. Header Card: Service Details Display */}
